function init(module, params) {
    ...
    module.myColumns = [{ label: 'BU', width: '3%', field: 'bu_name'},
                        { label: 'Employee', width: '8%', field: 'employee_name', class: 'key' },
                        { label: 'BU Date', width: '5%', field: 'bu_date', type: 'date', format: 'date' },
                        { label: 'EOD Time', width: '8%', field: 'eod_time', type: 'datetime', format: 'datatime' },
                        ...
                        { label: 'Over Shrt', width: '4%', field: 'over_short_amt', type: 'numeric', format: 'money' },
    ...
    module.myFilters = [{ name: 'myEmployee', field: 'employee_name', label: 'Employee', criteria: 'contains' }];

    module.myGrid = new spaGrid({
        form: module,
        id: 'myGrid',
        title: "Operations Employee Report",
        ...
        onSelect: function (id) {
            ...
            var EmpID = module.dsBrowse.GetCurrentRow().employee_id;
            createModule("Override Detail", "/custom/operations-report/overrides.htm", { 'bu_id': BuID, 'bu_date': BuDate, 'employee_id': EmpID }, 0);
        } 
    });
    ...
    module.dsBrowse = new spaDataset({
        ...
        id: 'dsBrowse',
        pk: 'bu_id',
        webservice: '/services/custom_supplier_Services.asmx/GetOperationReportByEmployee',
